                           ...
                           child: Row(
                             children: [
                               ClipRRect(
                                 ...
                                 child: Image.asset('assets/img/other_stores.jpg', height: settingsRepo.compact_view ? 70 : 90),
                               ),
                               const SizedBox(width: 20),
                               Text(
                                 "Other Stores",
                                 style: settingsRepo.compact_view ? TextStyle(fontSize: 16) : TextStyle(fontSize: 20),
                               )
                             ],
                           )))),
               Container(
                       ...
                       child: FlatButton(
                           ...
                           child: Row(
                             children: [
                               ClipRRect(
                                 borderRadius: BorderRadius.circular(8.0),
                                 child: Image.asset('assets/img/restaurants.jpg', height: settingsRepo.compact_view ? 70 : 90),
                               ),
                               const SizedBox(width: 20),
                               Text(
                                 "Home Cooked",
